<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="Cargos.aspx.cs" Inherits="Krappsena.Cargos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
      <h1>
       Cargos
        <small>Crear, Modificar y Eliminar Cargos</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="default.aspx"><i class="fa fa-th"></i> Inicio</a></li>
        <li><a href="Cargos.aspx"><i class="fa fa-users"></i>Cargos</a></li>
      </ol>
    </section>
