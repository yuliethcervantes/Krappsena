<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="Registro de novedades.aspx.cs" Inherits="Krappsena.Registro_de_novedades" %>
   ...
   <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        ...
        <small>Crear, Modificar y Eliminar Novedades</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="default.aspx"><i class="fa fa-th"></i> Inicio</a></li>
        <li><a href="registro de Novedades.aspx"><i class="fa fa-users"></i> Registro de Novedades</a></li>
      </ol>
    </section>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Registrar Novedades</h4>
              </div>
